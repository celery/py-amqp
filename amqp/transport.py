...
class _AbstractTransport(object):
    ...
    def __init__(self, host, connect_timeout, socket_settings=None):
        self.connected = True
        msg = None
        port = AMQP_PORT
...
class SSLTransport(_AbstractTransport):
    ...
    def __init__(self, host, connect_timeout, ssl, socket_settings=None):
...
def create_transport(host, connect_timeout, ssl=False,
    ...
    if ssl:
        return SSLTransport(host, connect_timeout, ssl, socket_settings)
    else:
        return TCPTransport(host, connect_timeout, socket_settings)
